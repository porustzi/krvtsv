    ...
    <section id="contact" className="py-16 md:py-32 bg-rose-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.3em] text-rose-500 mb-4">Зв'язок</p>
            <h2 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black uppercase leading-[0.9] text-gray-900 mb-6 md:mb-8">
              ДАВАЙ<br />
              <span className="text-rose-500">ПОГОВОРИМО</span>
            </h2>

            <p className="text-gray-500 text-base md:text-lg leading-relaxed mb-8 md:clmb-12 max-w-md mx-auto lg:mx-0">
            ...
            <div className="space-y-4 md:space-y-6 max-w-sm mx-auto lg:mx-0">
              <a
                ...
                className="group flex items-center gap-4 bg-white rounded-2xl px-5 py-4 md:px-6 md:py-5 hover:shadow-md transition-all duration-300 border-2 border-transparent hover:border-rose-200"
              >
                ...
                <div className="text-left">
                  <p className="text-[10px] uppercase tracking-widest text-gray-400 font-semibold mb-0.5">Telegram</p>
                  <p className="font-black text-sm md:text-base text-gray-900">@krvtsvcorp</p>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <p className="font-black text-sm md:text-base text-gray-900">hello@krvtsv.com</p>
                </div>
              </a>
            </div>
          </motion.div>
          ...
          >
            {sent ? (
              ...
              >
                ...
                <h3 className="text-xl md:text-2xl font-black uppercase text-gray-900 mb-3">Заявку отримано!</h3>
              ...
              <form
                ...
                className="bg-white rounded-3xl p-6 md:p-10 border-2 border-rose-100 space-y-4 md:space-y-5 shadow-xl shadow-rose-500/5"
              >
                <div>

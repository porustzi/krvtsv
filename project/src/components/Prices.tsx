...
const plans = [
  ...
  {
    name: 'Магазин', price: 'від 20 000 грн', duration: '14–21 день',
  ...
  {
    name: 'Редизайн', price: 'від 8 000 грн', duration: '5–10 днів',

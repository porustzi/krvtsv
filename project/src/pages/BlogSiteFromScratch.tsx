    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main>
        <article className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-3xl mx-auto px-4 sm:px-8">
          <p className="text-xs sm:text-[10px] font-black uppercase tracking-[0.3em] text-rose-500 mb-4">Чекліст / старт</p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Заявки? Продаж товару? Імідж? Мета визначає тип сайту. Для тесту — <Link to="/blog/landing-vs-website" className="text-rose-500 font-bold hover:underline">лендінг</Link>, для магазину — e-commerce.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Не копіюйте шаблони. Унікальний дизайн + ваші кольори = впізнаваність. Див. наші <Link to="/#project" className="text-rose-500 font-bold hover:underline">проєкти</Link>.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Метатеги, структура, швидкість. Щоб вас знайшли за запитом «замовити сайт». Входить у пакети — див. <Link to="/#prices" className="text-rose-500 font-bold hover:underline">ціни</Link>.
          </p>

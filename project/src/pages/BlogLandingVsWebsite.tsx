    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main>
        <article className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-3xl mx-auto px-4 sm:px-8">
          <p className="text-xs sm:text-[10px] font-black uppercase tracking-[0.3em] text-rose-500 mb-4">Гайд / вибір</p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Продаєте товари онлайн? Тоді потрібен магазин з кошиком, оплатою та каталогом. Це окремий тип проєкту — <Link to="/services/ecommerce" className="text-rose-500 font-bold hover:underline">розробка e-commerce</Link> від 15 000 грн.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Почніть з лендінгу, якщо тестуєте гіпотезу. Переросте — додамо сторінки. Потрібна допомога з вибором? <Link to="/services/web-developer-kyiv" className="text-rose-500 font-bold hover:underline">Замовіть сайт у веб-студії Київ</Link>.
          </p>

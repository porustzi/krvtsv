    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main>
        <article className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-3xl mx-auto px-4 sm:px-8">
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Якщо потрібен не тільки фронт, а й бекенд з базою даних — дивіться нашу сторінку <Link to="/services/fullstack" className="text-rose-600 font-bold hover:underline">фуллстак розробки</Link>. Для магазину — <Link to="/services/ecommerce" className="text-rose-600 font-bold hover:underline">розробку e-commerce</Link>.
          </p>

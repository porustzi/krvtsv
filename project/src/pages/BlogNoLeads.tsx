    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <main>
        <article className="pt-32 pb-16 md:pt-40 md:pb-24 max-w-3xl mx-auto px-4 sm:px-8">
          <p className="text-xs sm:text-[10px] font-black uppercase tracking-[0.3em] text-rose-500 mb-4">Проблема / рішення</p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Без відгуків, кейсів та контактів сайт виглядає як «одноденка». Додайте реальні проєкти (див. наші <Link to="/#project" className="text-rose-500 font-bold hover:underline">кейси</Link>), фото, посилання на соцмережі.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed mb-6">
            Без базового SEO вас ніхто не знайде. Потрібні метатеги, мікророзмітка, швидкість і структура. Це входить у наші пакети — див. <Link to="/#prices" className="text-rose-500 font-bold hover:underline">ціни</Link>.
          </p>
